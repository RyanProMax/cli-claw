...
import type { TelegramConnectionConfig } from './providers/telegram.js';
import type { QQConnectionConfig } from './providers/qq.js';
import type { WeChatConnectionConfig } from './providers/wechat/index.js';
import type { DingTalkConnectionConfig } from './providers/dingtalk.js';
import type { StreamingCardController } from './providers/feishu/streaming-card.js';
import { getRegisteredGroup, getJidsByFolder } from '../storage/db.js';
...
class IMConnectionManager {
  ...
  async sendMessage(
    ...
    await channel.sendMessage(chatId, text, localImagePaths, messageMeta);
  }
