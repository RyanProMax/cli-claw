...
import type { RegisteredGroup, SubAgent } from '../../domain/types.js';
import { logger } from '../../core/logger.js';
import { getChannelType, extractChatId } from '../../messaging/channel.js';
...
router.patch('/:jid/agents/:agentId', authMiddleware, async (c) => {
  ...
  broadcastAgentStatus(
    jid,
    agentId,
    agent.status as import('../../domain/types.js').AgentStatus,
    name,
    agent.prompt,
  );
