...
- Next action:
  - Continue with the next smallest reliability fix behind the lifecycle contract: startup recovery readiness, Feishu backfill ownership coverage, or remaining mirror/direct delivery cursor semantics.
