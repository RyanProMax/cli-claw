...
- Next action:
  - Continue with the next smallest reliability fix behind the lifecycle contract: delivery/cursor semantics, startup recovery readiness, or Feishu backfill ownership coverage.
