...
- Next action:
  - Apply milestone 24 with a safe restart, then monitor the next Feishu turn for `messageCount: 1`, no visible shutdown partial, and no `Falling back from WebSockets...` prefix in persisted assistant replies.
